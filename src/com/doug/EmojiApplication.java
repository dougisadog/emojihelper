...
import com.doug.emojihelper.error.ErrLogManager;
import com.doug.emojihelper.support.AppActivityLifecycleCallbacks;
import com.doug.emojihelper.support.CrashHandler;
import com.doug.emojihelper.support.ScreenObserver;
...
//		AnnotateUtil.writeErr(info);
	 ...
	 */
	    ...
	    private static EmojiApplication instance = null;
		...
		private Handler uiHandler = new Handler() {
	    	...
	    	public void handleMessage(Message msg) {
				...
				case SHOW_CONNECT_SERVER_ERR_MSG:
					Toast.makeText(EmojiApplication.getInstance().getActivity(), "connect fail", Toast.LENGTH_SHORT).show();
					break;
				case SHOW_SERVER_ERR_MSG:
					String serverMsg = (String) msg.obj;
					Toast.makeText(EmojiApplication.getInstance().getActivity(), serverMsg, Toast.LENGTH_SHORT).show();
					break;
				case SHOW_CUSTOM_ERR_MSG:
					String errMsg = (String) msg.obj;
					Toast.makeText(EmojiApplication.getInstance().getActivity(), errMsg, Toast.LENGTH_SHORT).show();
					break;
				case RESET_TO_LOGIN:
