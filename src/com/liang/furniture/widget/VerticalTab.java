 ...
 *
 */
public class VerticalTab extends LinearLayout {

	public VerticalTab(Context context, List<String> datas) {
		super(context);
	}

	public VerticalTab(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public VerticalTab(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public void setDatas(List<String> datas, ItemCallBack itemCallBack, LinearLayout.LayoutParams params) {
		this.datas = datas;
	...
	public void setDatas(List<String> datas, ItemCallBack itemCallBack) {
		setDatas(datas, itemCallBack, null);
	}
	...
	private void buildTabs() {
		if (null == params) {
			params = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, 240);
